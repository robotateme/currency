...
')
     ...
     */ 
         ...
         * @static 
         */ 
        public static function encode($array, $rootElementName = 'document', $replaceSpacesByUnderScoresInKeyNames = true, $xmlEncoding = 'UTF-8', $xmlVersion = '1.0')
        {
                        /** @var \Bmatovu\LaravelXml\Support\Facades\LaravelXml $instance */
                        return $instance->encode($array, $rootElementName, $replaceSpacesByUnderScoresInKeyNames, $xmlEncoding, $xmlVersion);
        }
                    /**
         ...
         * @static 
         */ 
        public static function is_valid($xml)
        {
                        /** @var \Bmatovu\LaravelXml\Support\Facades\LaravelXml $instance */
                        return $instance->is_valid($xml);
        }
                    /**
         * Validate XML string.
         *
        ...
        {
                        /** @var \Bmatovu\LaravelXml\Support\Facades\LaravelXml $instance */
                        return $instance->validate($xml, $xsd);
        }
